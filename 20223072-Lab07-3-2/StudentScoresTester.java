...
public class StudentScoresTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("GetHighest Name: " + studSc.getHighest().name + ", score: " + studSc.getHighest().score);
		
		System.out.println("GetLowest Name: " + studSc.getLowest().name + ", score: " + studSc.getLowest().score);
	}
